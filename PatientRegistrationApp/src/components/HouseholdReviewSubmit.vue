      ...
      <v-col cols="12">
        <div class="font-weight-medium">
          ...
          <span class="font-weight-regular">{{
            dataHouseholdHomeAddress.householdLineAddress
          }}</span>
        </div>
        <div class="font-weight-medium">
          City, County, State, Country, Zip Code:
          <span class="font-weight-regular"
            >{{ dataHouseholdHomeAddress.householdCityAddress }},
            {{ dataHouseholdHomeAddress.householdDistrictAddress }},
            {{ dataHouseholdHomeAddress.householdStateAddress }},
            {{ dataHouseholdHomeAddress.householdCountryAddress }},
            {{ dataHouseholdHomeAddress.householdPostalCode }}</span
          >
        </div>
      </v-col>
    </v-row>
    ...
    <v-row>
      <v-col cols="12">
        ...
        <div class="font-weight-medium">
          ...
          <span class="font-weight-regular"
            >{{ dataHouseholdContactInfo.secondaryPhoneNumber }} ({{
              dataHouseholdContactInfo.secondaryPhoneNumberType
            }})</span
          >
        </div>
        <div class="font-weight-medium">
        ...
        <div class="font-weight-medium">
          Follow-up approval:
          <span class="font-weight-regular">{{
            dataHouseholdContactInfo.approval
          }}</span>
        </div>
      </v-col>
    </v-row>
        ...
        <v-card class="d-flex flex-wrap" flat>
          <v-card class="pa-2" flat min-width="33%">
            ...
            <div class="font-weight-medium">
              Name:
              <span class="font-weight-regular"
                >{{ dataHouseholdPersonalInfo[0].householdFamilyName }},
                {{ dataHouseholdPersonalInfo[0].householdGivenName }}
                {{ dataHouseholdPersonalInfo[0].householdSuffix }}</span
              >
            </div>
            <div class="font-weight-medium">
              DOB:
              <span class="font-weight-regular">{{
                dataHouseholdPersonalInfo[0].householdBirthDate
              }}</span>
            </div>
            <div class="font-weight-medium">
              Gender ID:
              <span class="font-weight-regular">{{
                dataHouseholdPersonalInfo[0].householdGender
              }}</span>
            </div>
            <div class="font-weight-medium">
              Race(s):
              <span class="font-weight-regular">{{
                dataHouseholdPersonalInfo[0].householdRaceSelections
              }}</span>
            </div>
            <div class="font-weight-medium">
              Ethnicity:
              <span class="font-weight-regular">{{
                dataHouseholdPersonalInfo[0].householdEthnicitySelection
              }}</span>
            </div>
            ...
            <div class="font-weight-medium">
              ...
              <span class="font-weight-regular"
                >{{
                  dataHouseholdEmergencyContact.householdEmergencyContactFamilyName
                }},
                {{
                  dataHouseholdEmergencyContact.householdEmergencyContactGivenName
                }}</span
              >
            </div>
            <div class="font-weight-medium">
              ...
              <span class="font-weight-regular"
                >{{
                  dataHouseholdEmergencyContact.householdEmergencyContactPhoneNumber
                }}
                ({{
                  dataHouseholdEmergencyContact.householdEmergencyContactPhoneNumberType
                }})</span
              >
            </div>
          </v-card>
          ...
          >
            <div class="font-weight-medium primary--text">
              Personal Info: Household Member #{{ n + 1 }}
            </div>
            <div class="font-weight-medium">
              Name:
              <span class="font-weight-regular"
                ><!--{{dataHouseholdPersonalInfo[n].householdFamilyName}}, 
						{{dataHouseholdPersonalInfo[n].householdGivenName}} {{dataHouseholdPersonalInfo[n].householdSuffix}}--></span
              >
            </div>
            <div class="font-weight-medium">
              DOB:
              <span class="font-weight-regular"
                ><!--{{dataHouseholdPersonalInfo[n].householdBirthDate}}--></span
              >
            </div>
            <div class="font-weight-medium">
              Gender ID:
              <span class="font-weight-regular"
                ><!--{{dataHouseholdPersonalInfo[n].householdGender}}--></span
              >
            </div>
            <div class="font-weight-medium">
              Race(s):
              <span class="font-weight-regular"
                ><!--{{dataHouseholdPersonalInfo[n].householdRaceSelections}}--></span
              >
            </div>
            <div class="font-weight-medium">
              Ethnicity:
              <span class="font-weight-regular"
                ><!--{{dataHouseholdPersonalInfo[n].householdEthnicitySelection}}--></span
              >
            </div>
            <div class="font-weight-light primary--text">Emergency Contact</div>
            <div class="font-weight-medium">
              ...
              <span class="font-weight-regular"
                >{{ dataHouseholdPersonalInfo[0].householdFamilyName }},
                {{ dataHouseholdPersonalInfo[0].householdGivenName }}</span
              >
            </div>
            <div class="font-weight-medium">
              Phone:
