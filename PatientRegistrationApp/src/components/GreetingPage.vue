  ...
  <v-container bg fill-height grid-list-md text-xs-center>
    ...
    <v-row align="left" justify="left">
      ...
      <v-col cols="4">
        <span
          ><p style="font-size: 1.5em" class="font-weight-regular">
            <br />Select your registration type
          </p></span
        >
      </v-col>
      <v-col cols="4"> </v-col>
      ...
      <v-btn-toggle v-model="text" group>
        ...
        >
          <div>
            ...
            <span
              ><br />
              <p style="font-size: 1.2em" class="font-weight-regular">
                <br />Register myself
              </p></span
            >
          </div>
        ...
        <v-tooltip bottom max-width="20%">
          ...
          <span
            >A household is composed of any people who occupy the same given
            housing unit. If you are planning to register your household, all
            members must currently be residing in the same address. If members
            of a household are residing in other housing units, it is necessary
            to register any given members individually. Max household
            registration of 20 registrants.</span
          >
        </v-tooltip>
      </v-btn-toggle>
    </v-row>
