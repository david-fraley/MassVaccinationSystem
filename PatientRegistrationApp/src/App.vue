              ...
              <v-stepper-items>
                  ...
                  <v-stepper-content step="2">
                    <v-toolbar flat>
                      <v-toolbar-title
                        ...
                        >Enter your home address</v-toolbar-title
                      >
                    </v-toolbar>
                    <v-card flat
                ...
                <template v-if="isHouseholdRegistration()">
                  ...
                  <v-stepper-content step="7">
                    ...
                    <v-card flat
                      ><HouseholdPersonalInfo_n ref="householdPersonalInfo_n"
                    /></v-card>
                  </v-stepper-content>
                  ...
                  <v-stepper-content step="8">
                    <v-toolbar flat>
                      <v-toolbar-title
                        style="font-size: 1.5em"
                        class="font-weight-regular"
                        >Please ensure your household's information is
                        correct</v-toolbar-title
                      >
                    </v-toolbar>
...
export default {
  ...
  methods: {
    ...
    isHouseholdPatientReviewSubmit() {
      let returnValue = true;
      this.page == config.registrationPages.HOUSEHOLD_REVIEW_SUBMIT_PAGE
        ? (returnValue = true)
        : (returnValue = false);
      return returnValue;
    },
        ...
        switch (this.page) {
          ...
          case config.registrationPages.HOUSEHOLD_PERSONAL_INFO_PATIENT_N_PAGE:
            this.$refs.householdPersonalInfo_n.verifyFormContents()
              ? this.goToPage(
                  config.registrationPages.HOUSEHOLD_REVIEW_SUBMIT_PAGE
                )
              : this.goToPage(
                  config.registrationPages
                    .HOUSEHOLD_PERSONAL_INFO_PATIENT_N_PAGE
