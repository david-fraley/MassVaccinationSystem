  ...
  <v-app>
    <v-app-bar app clipped-right flat height="69" color="primary">
      <h1 class="font-weight-medium white--text">
        Point of Dispensing Application
      </h1>
      <v-spacer></v-spacer>
          ...
          <v-list-item :disabled="false" router :to="'/RetrievePatientRecord'">
            ...
            <v-list-item-content>
              <v-list-item-title class="font-weight-medium"
                >Retrieve Patient Record</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
          <!-- Check-In -->
          <v-list-item
            :disabled="isCheckInPageDisabled"
            router
            :to="'/CheckIn'"
          >
            <v-list-item-action>
            ...
            <v-list-item-content>
              <v-list-item-title class="font-weight-medium"
                >Check-In</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
          <!-- Patient History -->
          <v-list-item
            :disabled="isPatientHistoryPageDisabled"
            router
            :to="'/PatientHistory'"
          >
            <v-list-item-action>
            ...
            <v-list-item-content>
              <v-list-item-title class="font-weight-medium"
                >Patient History</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
          <!-- Consent and Screening -->
          <v-list-item
            :disabled="isConsentScreeningPageDisabled"
            router
            :to="'/ConsentScreening'"
          >
            <v-list-item-action>
            ...
            <v-list-item-content>
              <v-list-item-title class="font-weight-medium"
                >Consent and Screening</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
          <!-- Vaccination Event -->
          <v-list-item
            :disabled="isVaccinationEventPageDisabled"
            router
            :to="'/VaccinationEvent'"
          >
            <v-list-item-action>
            ...
            <v-list-item-content>
              <v-list-item-title class="font-weight-medium"
                >Vaccination Event</v-list-item-title
              >
            </v-list-item-content>
          </v-list-item>
          <!-- Discharge -->
          <v-list-item
            :disabled="isDischargePageDisabled"
            router
            :to="'/Discharge'"
          >
            <v-list-item-action>
