            ...
            <template v-slot:label>
              <div>
                ...
                <span class="font-weight-medium secondary--text"
                  >1. Are you feeling sick today?</span
                >
              </div>
            </template>
          </v-radio-group>
          ...
          <v-radio-group>
            <template v-slot:label>
              <div>
                <span class="red--text"><strong>* </strong></span>
                <span class="font-weight-medium secondary--text"
                  >2. Have you ever received a dose of COVID-19 Vaccine?</span
                >
              </div>
            </template>
          </v-radio-group>
            ...
            <template v-slot:label>
              <div>
                ...
                <span class="secondary--text"
                  >Which vaccine product did you receive?</span
                >
              </div>
            </template>
          </v-radio-group>
        ...
        <v-row>
          <v-radio-group>
            <template v-slot:label>
              <div>
                <span class="font-weight-medium secondary--text"
                  >3. Have you ever had an allergic reaction to:</span
                ><br />
                <span style="font-size:.8rem"
                  >(This would include a severe allergic reaction [e.g.
                  anaphylaxis] that required treatment with epinephrine or
                  EpiPen or that caused you to go to the hospital. It would also
                  include an allergic reaction that occurred within 4 hours that
                  caused hives, swelling, or respiratory distress, including
                  wheezing.)</span
                >
              </div>
            </template>
          ...
          <v-radio-group>
            <template v-slot:label>
              <div>
                <span class="red--text"><strong>* </strong></span>
                <span class="secondary--text"
                  >A component of the COVID-19 vaccine, including polyethylene
                  glycol (PEG), which is found in some medications, such as
                  laxatives and preparations for colonoscopy procedures.</span
                >
              </div>
            </template>
          </v-radio-group>
        ...
        <v-row>
          <v-radio-group>
            <template v-slot:label>
              <div>
                <span class="red--text"><strong>* </strong></span>
                <span class="secondary--text">Polysorbate</span>
              </div>
            </template>
          </v-radio-group>
        </v-row>
          ...
          <v-radio-group>
            <template v-slot:label>
              <div>
                <span class="red--text"><strong>* </strong></span>
                <span class="secondary--text"
                  >A previous dose of COVID-19 vaccine</span
                >
              </div>
            </template>
          </v-radio-group>
          ...
          <v-radio-group>
            <template v-slot:label>
              <div>
                <span class="red--text"><strong>* </strong></span>
                <span class="font-weight-medium secondary--text"
                  >4. Have you ever had an allergic reaction to another vaccine
                  (other than COVID-19 vaccine) or an injectable medication?<br
                /></span>
                <span style="font-size:.8rem"
                  >(This would include a severe allergic reaction [e.g.
                  anaphylaxis] that required treatment with epinephrine or
          ...
          <v-radio-group>
            <template v-slot:label>
              <div>
                <span class="red--text"><strong>* </strong></span>
                <span class="font-weight-medium secondary--text"
                  >5. Have you ever had a severe allergic reaction (e.g.,
                  anaphylaxis) to something other than a component of COVID-19
                  vaccine, polysorbate, or any vaccine or injectable medication?
                  This would include food, pet, environmental, or oral
          ...
          <v-radio-group>
            <template v-slot:label>
              <div>
                <span class="red--text"><strong>* </strong></span>
                <span class="font-weight-medium secondary--text"
                  >6. Have you received any vaccine in the last 14 days?</span
                >
              </div>
            </template>
          </v-radio-group>
          ...
          <v-radio-group>
            <template v-slot:label>
              <div>
                <span class="red--text"><strong>* </strong></span>
                <span class="font-weight-medium secondary--text"
                  >7. Are you currently under isolation or quarantine due to
                  COVID-19?</span
                >
              </div>
            </template>
          ...
          <v-radio-group>
            <template v-slot:label>
              <div>
                <span class="red--text"><strong>* </strong></span>
                <span class="font-weight-medium secondary--text"
                  >8. Have you received passive antibody therapy or convalescent
                  plasma as treatment for COVID-19 in the past 90 days?</span
                >
              </div>
            </template>
          </v-radio-group>
